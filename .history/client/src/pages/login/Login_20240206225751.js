                        ...
                        <form className="max-w-sm mx-auto">
...

                              {
                                showRegisterButton && (
                                    ...
                                    <p className="text-white text-center" onClick={!setShowRegisterButton}>Not registered yet?</p>
                              </div>
                                )
                              }

                              {
                                !showRegisterButton && (
                                    ...
                                    <p className="text-white text-center underline" onClick={()=>setShowRegisterButton}>Already Registered?</p>
                              </div>
                                )
                              }
                        </form>
