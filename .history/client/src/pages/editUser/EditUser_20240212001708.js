                  ...
                  <div className="w-[80%]">
                        ...
                        <form className="max-w-sm mx-auto">
                              ...
                              <div>
                                    ...
                                    <button
                                          type="submit"
                                          className="text-white mt-6 w-full bg-orange-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                                    >
                                          Cancel
                                    </button>
                              </div>
