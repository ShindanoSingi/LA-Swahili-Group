                                                      ...
                                                      <div class="flex cursor-pointer items-center justify-between">
                                                            <div className="flex items-center">
                                                                  ...
                                                                  <div className="flex-1 min-w-0 ms-4">
                                                                        ...
                                                                        <span className="text-sm text-gray-200 truncate dark:text-gray-200">Added By: <span className="text-sm text-gray-500 truncate dark:text-gray-400">Shindano</span> </span>
                                                                  </div>
                                                            </div>
