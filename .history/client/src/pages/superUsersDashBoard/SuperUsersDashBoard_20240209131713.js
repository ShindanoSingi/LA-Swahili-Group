                                    ...
                                    <li className={`py-3 sm:py-4`}>
                                          ...
                                          <div>
                                            <div className="inline-flex items-center text-base font-semibold text-gray-900 dark:text-white">
                                                ...
                                                <div className="group-hover:rotate-180 text-white h-3 w-4 transition-all duration-500  group-focus:-rotate-180 dark:text-white"><FaAngleDown /></div>

                                                {/* <span class="icon-[ic--baseline-keyboard-arrow-down] group-hover:rotate-180 text-white h-2 w-3 transition-all duration-500  group-focus:-rotate-180 dark:text-white"></span> */}
                                          </div>
