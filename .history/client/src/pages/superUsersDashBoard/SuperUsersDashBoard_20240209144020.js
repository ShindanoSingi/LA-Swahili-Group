                                    ...
                                    <li className={`py-3 sm:py-4`}>
                                          ...
                                          <div>
                                            <div className="inline-flex items-center text-base font-semibold text-gray-900 dark:text-white">
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="feather transition-all duration-500  group-focus:-rotate-180 dark:text-whitefeather-chevron-down"><polyline points="6 9 12 15 18 9"></polyline></svg>
                                          </div>
                                                      ...
                                                      <div class="invisible flex justify-around h-auto max-h-0 items-center opacity-0 transition-all group-focus:visible group-focus:max-h-screen group-focus:opacity-100 group-focus:duration-1000">
                                                            <button className="flex justify-center items-center bg-green-500 rounded-full w-16 p-1 max-w-20">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>
                                                            </button>
                                                            <button className="flex justify-center items-center bg-yellow-500 rounded-full w-16 p-1 max-w-20">
                                                            ...
                                                            <button className="flex justify-center items-center bg-red-500 rounded-full w-16 p-1 max-w-20">
