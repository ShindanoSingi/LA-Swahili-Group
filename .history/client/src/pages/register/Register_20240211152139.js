      ...
      return (
            <div className="container">
                  <div className="w-[80%]">
                         ...
                         <h1 className="text-xl font-bold text-center mb-4 text-white dark:text-white">Registration Form</h1>
                  <form className="max-w-sm mx-auto">
                              ...
                              <div className="mb-3">
                                    ...
                                    <p className="text-white text-center underline">Already Registered?</p>
                              </div>
                        </form>
                  </div>
            </div>
