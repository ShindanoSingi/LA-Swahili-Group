    ...
    const [showRegisterButton, setShowRegisterButton] = useState(false);
      ...
      return (
            <div className="container">
                  <div className="w-[80%]">
                    {
                        !showRegisterButton && (                        <h1 className="text-xl font-bold text-center mb-4 text-white dark:text-white">Registration Form</h1>
                        )
                    }
                    {
                        showRegisterButton && (                        <h1 className="text-xl font-bold text-center mb-4 text-white dark:text-white">Register Form</h1>
                        )
                    }
