...
function AdminDashBoard() {
      ...
      const showInput = useSelector(state => state.userReducer.showInput);
       ...
       // State to track the rotation of each card
  const [rotatedStates, setRotatedStates] = useState({});
      ...
      // Toggle rotation for a specific card based on the user ID
  const handleClick = (userId) => {
    setRotatedStates((prev) => ({
      ...prev,
      [userId]: !prev[userId],  // Toggle the rotation state for the clicked card
    }));
  };
                                                  ...
                                                  users.users.map(
                                                        (user, index) =>
                                                              ...
                                                              >
                                                                    <div>
                                                                          <div
                                                                                class="group flex flex-col rounded-lg  h-auto  group-focus:max-h-screen group-focus:opacity-100 group-focus:duration-1000 group-focus:visible transition-all bg-black p-2 md:px-4 md:py-0 md:pb-4 md:text-lg text-white"
                                                                                tabindex={
                                                                                      index
                                                                                }
                                                                          >
                                                                                <div className="flex cursor-pointer items-center justify-between">
                                                                                      <div className="flex items-center">
                                                                                            <div className="flex-shrink-0">
                                                                                                  ...
                                                                                                  {user.profilePicture
                                                                                                        ? <div
                                                                                                          >
                                                                                                                <p className="text-lg relative left-[2rem] top-[2rem] md:left-[6rem] rounded-full w-10 md:w-10 md:rounded-full flex justify-center items-center h-10 bg-yellow-700 text-white truncate">
                                                                                                                      {index +
                                                                                                                            1}
                                                                                                                </p>
                                                                                                                <img
                                                                                                                      ...
                                                                                                                      className="h-10 w-10 md:w-[8rem] md:h-[8rem] rounded-full"
                                                                                                                />
                                                                                                          </div>
                                                                                                        : <div
                                                                                                          >
                                                                                      ...
                                                                                      <div className="flex flex-col items-center">
                                                                                            ...
                                                                                            <IoIosArrowDown
  className={`feather transition-all duration-500 ${rotatedStates[user._id] ? "rotate-0" : "rotate-180"} dark:text-white`}
